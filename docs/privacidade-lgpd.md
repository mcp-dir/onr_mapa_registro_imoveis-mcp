...
ONR: Mapa do Registro de Imóveis segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [onr_mapa_registro_imoveis@mcp.ai](mailto:onr_mapa_registro_imoveis@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
